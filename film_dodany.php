...
<body>
	...
	<div id="container">
		...
		<div id="content">
			<div id="main">
				Film dodano do bazy pomyślnie:</br>
				
				<?php
				
				$idfilmu = mysqli_fetch_array(mysqli_query($con, 'SELECT max(IdFilm) FROM film'));
				$filmik = $idfilmu[0];
				echo '<b>'.$filmik.'';
				
				$danefilmu = mysqli_fetch_array(mysqli_query($con, 'SELECT * FROM film WHERE IdFilm='.$filmik.''));
				 echo '&nbsp&nbsp&nbsp <b>'.$danefilmu['tytul'].'' ;
