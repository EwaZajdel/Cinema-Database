				...
				else
				{
					if ($wszystko_OK==true)
					{
						...
						if ($polaczenie->query('DELETE FROM bilet WHERE IdBilet = '.$IdBilet.''))
						{
							...
							echo 'SUKCES';
							header('Location: baza_biletow.php');
	...
	<div id="container">
		...
		<div id="nav">
			...
			<ul>
				...
				<li><a href="#" style="color: green">bilet-klient</a></li>
		...
		<tr><td><b>Numer biletu</b></td><td><b>Tytuł</b></td><td><b>Data</b></td><td><b>Numer miejsca</b></td><td><b>Email</b></td></tr>';
		$bilety = mysqli_query($con, 'SELECT * FROM  v_zamowienia WHERE IdBilet IS NOT NULL');
